...
public class Demo {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Judge> judges = addJudges();
        ArrayList<Jury> jury = addJury();
        ArrayList<Lawyer> lawyers = addLawyers();
        ArrayList<Prosecutor> prosecutors = addProsecutors();
        ArrayList<Accuser> accusers = addAccusers();
        ArrayList<Defendant> defendants = addDefendant();
        ArrayList<Witness> witnesses = addWitnesses();
    ...
    private static ArrayList<Judge> addJudges() {
    ...
    private static ArrayList<Lawyer>addLawyers(){
    ...
    private static ArrayList<Jury> addJury(){
    ...
    private static ArrayList<Prosecutor> addProsecutors(){
    ...
    private static ArrayList<Accuser> addAccusers(){
    ...
    private static ArrayList<Defendant> addDefendant(){
    ...
    private static ArrayList<Witness> addWitnesses(){
